...
const orders: Order[] = [
  ...
  // BL 2 - 5 produits (dans 1 semaine)
  {
    ...
    items: [
      ...
      { productId: '2', quantity: 120 }, // Partagé avec BC1
      { productId: '3', quantity: 180 }, // Partagé avec BC1
  ...
  // BC 3 - 4 produits (dans 2 semaines)
  {
    ...
    items: [
      ...
      { productId: '6', quantity: 80 }, // Unique à BC3
    ],
    totalHT: 1800,
  },
  // BC 4 - Auchan (même jour que BC3)
  {
    ...
    items: [
      ...
      { productId: '2', quantity: 80 }, // Tapenade Verte (partagé avec BC3)
      { productId: '3', quantity: 160 }, // Houmous Original
    ],
    totalHT: 2200,
  },
  // BC 5 - Carrefour (même jour que BC3 et BC4)
  {
    ...
    items: [
      ...
      { productId: '4', quantity: 110 }, // Caviar d'Aubergine (partagé avec BC3)
      { productId: '5', quantity: 75 }, // Tapenade Violette (partagé avec BC3)
    ],
    totalHT: 1950,
  },
  // BC 6 - Leclerc (fin janvier 2026)
  {
    ...
    items: [
      ...
      { productId: '3', quantity: 140 }, // Houmous Original
      { productId: '6', quantity: 60 }, // Tzatziki
    ],
    totalHT: 1750,
  },
  // BC 7 - Auchan (février 2026)
  {
    ...
    items: [
      ...
      { productId: '4', quantity: 85 }, // Caviar d'Aubergine
      { productId: '5', quantity: 120 }, // Tapenade Violette
    ],
    totalHT: 2100,
  },
  // BL 8 - Carrefour (mars 2026)
  {
    ...
    items: [
      ...
      { productId: '2', quantity: 100 }, // Tapenade Verte
      { productId: '3', quantity: 175 }, // Houmous Original
      { productId: '5', quantity: 90 }, // Tapenade Violette
    ],
    totalHT: 2450,
  },
  // BL 9 - Leclerc (avril 2026)
  {
    ...
    items: [
      ...
      { productId: '4', quantity: 75 }, // Caviar d'Aubergine
  ...
  return (
    <div className='absolute bg-[#12895a] bottom-0 flex items-center justify-around left-1/2 translate-x-[-50%] w-[393px] h-[75px]'>
      <div className='flex flex-col items-center text-white opacity-50'>
        <HomeIcon sx={{ fontSize: 28, marginBottom: '4px' }} />
      </div>
...
export default function App() {
  ...
  const getAggregatedProducts = () => {
    ...
    if (activeMode === 'period') {
      ...
      ordersToAggregate = orders.filter((order) =>
  ...
  return (
    <div className='bg-white relative w-[393px] h-[852px] mx-auto'>
      <StatusBar />
      <TabBar />
      <HomeIndicator />
      <NavBar />
      ...
      {/* Header */}
      <div className='absolute bg-white h-[56px] left-0 top-[83px] w-[393px] border-b border-gray-200'>
        <div className='flex gap-4 items-center px-4 py-2 h-full'>
          <p className='font-semibold text-[16px]'>Logistique</p>
      ...
      {/* Main Content */}
      <div className='absolute bg-white top-[139px] left-0 w-[393px] h-[639px] overflow-y-auto px-4 py-7'>
        ...
        {mode === 'clients' && showOrderDetailsPage && selectedOrder ? (
          <div className='pb-20'>
            ...
            <div className='flex items-start justify-between mb-3 pb-3 border-b border-gray-200'>
              ...
              <img
                src={
                  selectedOrder.client === 'Carrefour'
                    ? imgCarrefour
                    : selectedOrder.client === 'Auchan'
                    ? imgAuchan
                    : selectedOrder.client === 'Leclerc'
                    ? imgLeclerc
                    : ''
                }
                alt=''
            ...
            <div className='flex items-center justify-between mb-2 py-1'>
              ...
              >
                {selectedProductsInOrder.length === selectedOrder.items.length
                  ? 'Tout désélectionner'
                  : 'Tout sélectionner'}
              </button>
            </div>
          ...
          <div className='flex gap-4 items-center mb-4'>
            ...
            <div className='flex gap-2 ml-auto'>
              ...
              >
                ...
                <span className='text-[12px] font-semibold'>Calendrier</span>
              </button>
            </div>
          </div>
        )}
            ...
            <div className='space-y-3 mb-4'>
              {getAggregatedProducts().length > 0 ? (
                getAggregatedProducts().map(
                  ({ product, quantity, deficit, orders: productOrders }) => (
                    <div
                      key={product.id}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className='flex items-start gap-3'>
                        ...
                        <img
                          src={
                            order.client === 'Carrefour'
                              ? imgCarrefour
                              : order.client === 'Auchan'
                              ? imgAuchan
                              : order.client === 'Leclerc'
                              ? imgLeclerc
                              : ''
                          }
                          alt=''
